  ...
  render: () => (
    <div className="relative min-h-screen w-full overflow-hidden bg-magic-void p-8 text-text-body">
      ...
      <div className="relative z-10 space-y-12 max-w-4xl mx-auto">
        ...
        <section className="space-y-4">
          <Typography.H2>Loading States</Typography.H2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Terminal title="DATA_STREAM_PENDING" className="h-40 flex flex-col gap-4 p-4">
              <Skeleton variant="text" className="w-1/2" />
              <Skeleton variant="rect" className="flex-grow" />
            </Terminal>
            <Card className="flex flex-col items-center justify-center gap-4 p-8">
              <Spinner className="h-12 w-12 text-ectoplasm" />
              <Typography.Body className="animate-pulse italic">SYNCING_WITH_VOID...</Typography.Body>
            </Card>
          </div>
        </section>
